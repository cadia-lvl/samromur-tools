...
from os.path import join, pardir, abspath, dirname, isdir, exists
...
def remove_punct_lower(token) -> str:
    '''
    Added this to handle punctuation error
    '''
    return sub('[.|,|?|:]','', token).lower().rstrip()
...
class MarosijoCommon:
    ...
    def __init__(self, modelPath=None, downsample=False, graphs=True):
        ...
        try:
            ...
            self.kaldiRoot = environ['KALDI_ROOT']
        except KeyError:
