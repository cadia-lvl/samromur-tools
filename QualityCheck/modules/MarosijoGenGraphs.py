...
def genGraphs(prompts:list, u_prefix):
    """
    ...
    output_folder = join(conf['model'], 'temp')

    if not exists(output_folder):
        mkdir(output_folder)

    graphsArkPath = join(output_folder, f'{u_prefix}_graphs.ark')
    graphsScpPath = join(output_folder, f'{u_prefix}_graphs.scp')
